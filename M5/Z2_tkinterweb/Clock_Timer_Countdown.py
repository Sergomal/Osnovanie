...
stopwatch_pause_button = Button(
    stopwatch_tab, text="Pause", font="Calibri 12", command=lambda: stopwatch("pause")
)
stopwatch_pause_button.pack(anchor="s")

stopwatch_resume_button = Button(
    stopwatch_tab, text="Resume", font="Calibri 12", command=lambda: stopwatch("resume")
)
stopwatch_resume_button.pack(anchor="center")

stopwatch_reset_button = Button(
    stopwatch_tab, text="Reset", font="Calibri 12", command=lambda: stopwatch("reset")
)
...
timer_start_button = Button(
    timer_tab, text="Start", font="Calibri 18", command=lambda: timer("start")
)
